...
public:
	...
	double Eval(const Eigen::Vector3d& _x)
	{
		...
		Eigen::Vector3d centered_x = _x - m_center;
		return centered_x[0] * centered_x[0] + centered_x[1] * centered_x[1] + centered_x[2] * centered_x[2] - m_radius * m_radius;
	}
...
public:
	...
	double Eval(const Eigen::Vector3d& _x)
	{
		...
		Eigen::Vector3d centered_x = _x - m_center;
		double term1 = centered_x[0] * centered_x[0] + centered_x[1] * centered_x[1] + centered_x[2] * centered_x[2] + m_radius * m_radius - m_a * m_a;
		double term2 = 4 * m_radius * m_radius * (centered_x[0] * centered_x[0] + centered_x[1] * centered_x[1]);
...
public:
	...
	double Eval(const Eigen::Vector3d& _x)
	{
		...
		result += Eigen::Vector3d(m_coefficents[m_numCenters], m_coefficents[m_numCenters + 1], m_coefficents[m_numCenters + 2]).dot(_x);
